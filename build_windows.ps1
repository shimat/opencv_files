function BuildForWindows($targetPlatform, $vcpkgPath, $runMsbuild, $hostPlatform) {
    ...
    cmake -G "Visual Studio 17 2022" `
        ...
        -D AVIF_INCLUDE_DIR="${vcpkgPath}/installed/${targetPlatform}-windows-static/include" `
        -D AVIF_LIBRARY="${vcpkgPath}/installed/${targetPlatform}-windows-static/lib/avif.lib" `
